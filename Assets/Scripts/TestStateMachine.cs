...
/// ステートマシン
/// </summary>
public class TestStateMachine<TOwner>
{
    /// <summary>
    /// ステートを表すクラス
    /// </summary>
    public abstract class State
    {
        ...
        /// </summary>
        protected TestStateMachine<TOwner> StateMachine => stateMachine;
        internal TestStateMachine<TOwner> stateMachine;
        /// <summary>
        /// 遷移の一覧
        /// </summary>
    ...
    public TestStateMachine(TOwner owner)
    {
        Owner = owner;
    }
